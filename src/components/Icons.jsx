...
export const Gift = (p) => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...p}>
    <path d="M4 9h16v3H4z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
    <path d="M5 12h14v8a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
    <path d="M12 9v12M12 9C10 6 7.5 5 6.3 6.2 5.1 7.4 6.5 9 9 9m3 0c2-3 4.5-4 5.7-2.8C18.9 7.4 17.5 9 15 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
